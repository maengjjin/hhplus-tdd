...
public class PointServiceTest {
    ...
    @Test
    @DisplayName("0이나 음수로 잘못 충전 했을 때 실패")
    void chargePointTest2(){

        //given : 충전금액이  point <= 0
        long point = -1000L;

        // when : 잘못 된 포인트 금액 충전 & 검증
        assertThrows(IllegalArgumentException.class, ()-> service.chargePoint(id, point));
    ...
    @Test
    @DisplayName("사용할 포인트가 부족 할 때 exception") // 0은 컨트롤러 에서 검증
